...
const CommentList = ({ fullWidth = true, maxHeight = true, limit = null, toggleShowMore = false }) => {
  ...
  return (
    ...
    <div className={`overflow-auto overflow-y-auto ${fullWidth ? "w-full" : "w-1/2"} ${maxHeight ? "" : "max-h-[50vh]"}`}>
      ...
      {/* Reviews Grid */}
      <div className={`grid gap-1 ${column === 1 ? "lg:grid-cols-1" : "lg:grid-cols-2"} grid-cols-1`}>
