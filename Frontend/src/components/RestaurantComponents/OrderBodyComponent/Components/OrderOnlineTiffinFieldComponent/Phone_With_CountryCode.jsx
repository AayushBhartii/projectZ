...
const PhoneInput = ({ value, onChange, errors, required = false, }) => {
    ...
    return (
        <div className="mt-0 w-full">
            <label htmlFor="phone" className="block font-medium text-gray-700 text-sm mt-0">
                Phone
            </label>
            <div className="flex gap-2 w-full">
                ...
                <div className="flex-1 w-full">
                    <input
                        ...
                        className={`w-full py-1 px-2 border rounded-md ${!isValid && phoneNumber ? 'border-red-500' : 'border-gray-300'
                            }`}
